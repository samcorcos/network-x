...
seed = ->
  ...
  Neo4j.query "MATCH (a:Person {name:'Person A'}) MATCH (b:Company {name:'Company A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person A'}) MATCH (b:Company {name:'Company B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person A'}) MATCH (b:Company {name:'Company C'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person B'}) MATCH (b:Company {name:'Company A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person C'}) MATCH (b:Company {name:'Company A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person D'}) MATCH (b:Company {name:'Company A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person E'}) MATCH (b:Company {name:'Company A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person F'}) MATCH (b:Company {name:'Company B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person G'}) MATCH (b:Company {name:'Company B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person H'}) MATCH (b:Company {name:'Company B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person I'}) MATCH (b:Company {name:'Company B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person J'}) MATCH (b:Company {name:'Company B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person K'}) MATCH (b:Company {name:'Company B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person L'}) MATCH (b:Company {name:'Company C'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person M'}) MATCH (b:Company {name:'Company C'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person N'}) MATCH (b:Company {name:'Company C'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person O'}) MATCH (b:Company {name:'Company C'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person P'}) MATCH (b:Company {name:'Company C'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person Q'}) MATCH (b:Company {name:'Company C'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person R'}) MATCH (b:Company {name:'Company D'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person S'}) MATCH (b:Company {name:'Company D'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person T'}) MATCH (b:Company {name:'Company D'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person U'}) MATCH (b:Company {name:'Company D'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person V'}) MATCH (b:Company {name:'Company D'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person W'}) MATCH (b:Company {name:'Company E'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person X'}) MATCH (b:Company {name:'Company E'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person Y'}) MATCH (b:Company {name:'Company E'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person Z'}) MATCH (b:Company {name:'Company E'}) CREATE (a)-[r:WORKS_FOR]->(b)"

  # Creating "who works for who" edges with regards to people and organizations
  Neo4j.query "MATCH (a:Person {name:'Person A'}) MATCH (b:Organization {name:'Organization A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person C'}) MATCH (b:Organization {name:'Organization A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person Z'}) MATCH (b:Organization {name:'Organization A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person R'}) MATCH (b:Organization {name:'Organization A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person U'}) MATCH (b:Organization {name:'Organization A'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person S'}) MATCH (b:Organization {name:'Organization B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person T'}) MATCH (b:Organization {name:'Organization B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person U'}) MATCH (b:Organization {name:'Organization B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
  Neo4j.query "MATCH (a:Person {name:'Person V'}) MATCH (b:Organization {name:'Organization B'}) CREATE (a)-[r:WORKS_FOR]->(b)"
